...
export function LobbyView({
    ...
    return (
        <>
            ...
            <Modal opened={topicOpened} onClose={closeTopic} title="Game Case" centered size="lg">
                <Stack>
                    <Text mt="md">{room.topicDescription || "No case description available for this topic."}</Text>
                    <Checkbox
                            ...
                            {Array.from({ length: room.maxPlayers }).map((_, index) => {
                                ...
                                return (
                                    <PlayerSlot
                                        ...
                                        onTransferHost={() => player && onTransferHost(player.playerId)}
                                    />
                                );
                            })}
                        </SimpleGrid>
