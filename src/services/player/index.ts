...
export const createPlayerSession = async (
  payload: CreatePlayerSessionPayload
): Promise<PlayerSessionInfo> => {
  try {
    const response = await axios.post<PlayerSessionInfo>(
      `${API_URL}/create-player-session`,
      payload
    );
...
export const deletePlayerSession = async (
  payload: DeletePlayerSessionPayload
): Promise<any> => {
  try {
    const response = await axios.post(
      `${API_URL}/delete-player-session`,
      payload
    );
    return response.data;
  } catch (error) {
...
export const loginPlayer = async (
  payload: LoginPlayerPayload
): Promise<{ players: ApiPlayer[] }> => {
  try {
    const response = await axios.post<{ players: ApiPlayer[] }>(
      `${API_URL}/login-player`,
      payload
    );
    return response.data;
  } catch (error) {
